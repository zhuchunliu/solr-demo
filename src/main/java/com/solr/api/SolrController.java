...
public class SolrController {
    ...
    public String add() {
        ...
        try {
            ...
            doc.setField("product_price",20);
            doc.setField("product_title","近期美国以中美贸易不平衡为由，对中国先采取滥用贸易救济措施的做法");
//            doc.setField("product_title","测试数据");
    ...
    public String getById(@PathVariable String id) throws Exception {
        SolrDocument document = client.getById("collection1", id);
    ...
    public Map<String, Map<String, List<String>>> search(){
        ...
        try {
            ...
            //查询条件, 这里的 q 对应 下面图片标红的地方，必须加上  product_title: 要不无法高亮
            params.set("q", "product_title:美利坚合众国");

            //过滤条件
            params.set("fq", "product_price:[0 TO 50]");
            ...
            QueryResponse queryResponse = client.query("collection1",params);
